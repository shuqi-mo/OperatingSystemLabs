...
main(void) {
  ...
  800f80:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  800f83:	c7 04 24 a0 12 80 00 	movl   $0x8012a0,(%esp)
  800f8a:	e8 41 f3 ff ff       	call   8002d0 <cprintf>
    cprintf("I am process %d.\n", getpid());
  800f8f:	e8 be f2 ff ff       	call   800252 <getpid>
  800f94:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f98:	c7 04 24 b0 12 80 00 	movl   $0x8012b0,(%esp)
  800f9f:	e8 2c f3 ff ff       	call   8002d0 <cprintf>
    cprintf("hello pass.\n");
  800fa4:	c7 04 24 c2 12 80 00 	movl   $0x8012c2,(%esp)
  800fab:	e8 20 f3 ff ff       	call   8002d0 <cprintf>
    return 0;
