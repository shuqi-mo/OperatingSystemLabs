...
exit(int error_code) {
  ...
  8001e0:	c7 04 24 58 11 80 00 	movl   $0x801158,(%esp)
...
umain(void) {
  ...
  800348:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  80034b:	e8 d3 0c 00 00       	call   801023 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008ef:	05 84 12 80 00       	add    $0x801284,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a3f:	8b 04 85 a8 12 80 00 	mov    0x8012a8(,%eax,4),%eax
  ...
  800b41:	c7 44 24 08 9e 12 80 	movl   $0x80129e,0x8(%esp)
  800b48:	00 
  ...
  800b6d:	75 05                	jne    800b74 <vprintfmt+0x1a3>
                p = "(null)";
  800b6f:	be a1 12 80 00       	mov    $0x8012a1,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  800f7d:	83 ec 08             	sub    $0x8,%esp
    yield();
  800f80:	e8 ac f2 ff ff       	call   800231 <yield>
    yield();
  800f85:	e8 a7 f2 ff ff       	call   800231 <yield>
    yield();
  800f8a:	e8 a2 f2 ff ff       	call   800231 <yield>
    yield();
  800f8f:	e8 9d f2 ff ff       	call   800231 <yield>
    yield();
  800f94:	e8 98 f2 ff ff       	call   800231 <yield>
    yield();
  800f99:	e8 93 f2 ff ff       	call   800231 <yield>
}
  800f9e:	90                   	nop
  800f9f:	c9                   	leave  
  800fa0:	c3                   	ret    
...
loop(void) {
  ...
  800fa4:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  800fa7:	c7 04 24 00 14 80 00 	movl   $0x801400,(%esp)
  800fae:	e8 1d f3 ff ff       	call   8002d0 <cprintf>
    while (1);
  800fb3:	eb fe                	jmp    800fb3 <loop+0x12>
...
work(void) {
  ...
  800fb8:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  800fbb:	c7 04 24 0a 14 80 00 	movl   $0x80140a,(%esp)
  800fc2:	e8 09 f3 ff ff       	call   8002d0 <cprintf>
    do_yield();
  800fc7:	e8 ae ff ff ff       	call   800f7a <do_yield>
    if (kill(parent) == 0) {
  800fcc:	a1 08 20 80 00       	mov    0x802008,%eax
  800fd1:	89 04 24             	mov    %eax,(%esp)
  800fd4:	e8 66 f2 ff ff       	call   80023f <kill>
  800fd9:	85 c0                	test   %eax,%eax
  800fdb:	75 3a                	jne    801017 <work+0x62>
        cprintf("kill parent ok.\n");
  800fdd:	c7 04 24 14 14 80 00 	movl   $0x801414,(%esp)
  800fe4:	e8 e7 f2 ff ff       	call   8002d0 <cprintf>
        do_yield();
  800fe9:	e8 8c ff ff ff       	call   800f7a <do_yield>
        if (kill(pid1) == 0) {
  800fee:	a1 10 20 80 00       	mov    0x802010,%eax
  800ff3:	89 04 24             	mov    %eax,(%esp)
  800ff6:	e8 44 f2 ff ff       	call   80023f <kill>
  800ffb:	85 c0                	test   %eax,%eax
  800ffd:	75 18                	jne    801017 <work+0x62>
            cprintf("kill child1 ok.\n");
  800fff:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
  801006:	e8 c5 f2 ff ff       	call   8002d0 <cprintf>
            exit(0);
  80100b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801012:	e8 b8 f1 ff ff       	call   8001cf <exit>
        }
    }
    exit(-1);
  801017:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80101e:	e8 ac f1 ff ff       	call   8001cf <exit>
...
main(void) {
  ...
  801026:	83 e4 f0             	and    $0xfffffff0,%esp
  801029:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  80102c:	e8 21 f2 ff ff       	call   800252 <getpid>
  801031:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  801036:	e8 b3 f1 ff ff       	call   8001ee <fork>
  80103b:	a3 10 20 80 00       	mov    %eax,0x802010
  801040:	a1 10 20 80 00       	mov    0x802010,%eax
  801045:	85 c0                	test   %eax,%eax
  801047:	75 05                	jne    80104e <main+0x2b>
        loop();
  801049:	e8 53 ff ff ff       	call   800fa1 <loop>
    }

    assert(pid1 > 0);
  80104e:	a1 10 20 80 00       	mov    0x802010,%eax
  801053:	85 c0                	test   %eax,%eax
  801055:	7f 24                	jg     80107b <main+0x58>
  801057:	c7 44 24 0c 36 14 80 	movl   $0x801436,0xc(%esp)
  80105e:	00 
  80105f:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  801066:	00 
  801067:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  80106e:	00 
  80106f:	c7 04 24 54 14 80 00 	movl   $0x801454,(%esp)
  801076:	e8 a5 ef ff ff       	call   800020 <__panic>

    if ((pid2 = fork()) == 0) {
  80107b:	e8 6e f1 ff ff       	call   8001ee <fork>
  801080:	a3 0c 20 80 00       	mov    %eax,0x80200c
  801085:	a1 0c 20 80 00       	mov    0x80200c,%eax
  80108a:	85 c0                	test   %eax,%eax
  80108c:	75 05                	jne    801093 <main+0x70>
        work();
  80108e:	e8 22 ff ff ff       	call   800fb5 <work>
    }
    if (pid2 > 0) {
  801093:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801098:	85 c0                	test   %eax,%eax
  80109a:	7e 46                	jle    8010e2 <main+0xbf>
        cprintf("wait child 1.\n");
  80109c:	c7 04 24 64 14 80 00 	movl   $0x801464,(%esp)
  8010a3:	e8 28 f2 ff ff       	call   8002d0 <cprintf>
        waitpid(pid1, NULL);
  8010a8:	a1 10 20 80 00       	mov    0x802010,%eax
  8010ad:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8010b4:	00 
  8010b5:	89 04 24             	mov    %eax,(%esp)
  8010b8:	e8 5a f1 ff ff       	call   800217 <waitpid>
        panic("waitpid %d returns\n", pid1);
  8010bd:	a1 10 20 80 00       	mov    0x802010,%eax
  8010c2:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010c6:	c7 44 24 08 73 14 80 	movl   $0x801473,0x8(%esp)
  8010cd:	00 
  8010ce:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  8010d5:	00 
  8010d6:	c7 04 24 54 14 80 00 	movl   $0x801454,(%esp)
  8010dd:	e8 3e ef ff ff       	call   800020 <__panic>
    }
    else {
        kill(pid1);
  8010e2:	a1 10 20 80 00       	mov    0x802010,%eax
  8010e7:	89 04 24             	mov    %eax,(%esp)
  8010ea:	e8 50 f1 ff ff       	call   80023f <kill>
    }
    panic("FAIL: T.T\n");
  8010ef:	c7 44 24 08 87 14 80 	movl   $0x801487,0x8(%esp)
  8010f6:	00 
  8010f7:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  8010fe:	00 
  8010ff:	c7 04 24 54 14 80 00 	movl   $0x801454,(%esp)
  801106:	e8 15 ef ff ff       	call   800020 <__panic>
