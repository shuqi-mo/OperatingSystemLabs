...
exit(int error_code) {
  ...
  8001e0:	c7 04 24 98 10 80 00 	movl   $0x801098,(%esp)
...
umain(void) {
  ...
  800348:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  80034b:	e8 e3 0c 00 00       	call   801033 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008ef:	05 c4 11 80 00       	add    $0x8011c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a3f:	8b 04 85 e8 11 80 00 	mov    0x8011e8(,%eax,4),%eax
  ...
  800b41:	c7 44 24 08 de 11 80 	movl   $0x8011de,0x8(%esp)
  800b48:	00 
  ...
  800b6d:	75 05                	jne    800b74 <vprintfmt+0x1a3>
                p = "(null)";
  800b6f:	be e1 11 80 00       	mov    $0x8011e1,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  800f7d:	83 ec 48             	sub    $0x48,%esp
  800f80:	8b 45 0c             	mov    0xc(%ebp),%eax
  800f83:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  800f86:	8b 45 08             	mov    0x8(%ebp),%eax
  800f89:	89 04 24             	mov    %eax,(%esp)
  800f8c:	e8 cd f3 ff ff       	call   80035e <strlen>
  800f91:	83 f8 03             	cmp    $0x3,%eax
  800f94:	77 4f                	ja     800fe5 <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  800f96:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  800f9a:	89 44 24 10          	mov    %eax,0x10(%esp)
  800f9e:	8b 45 08             	mov    0x8(%ebp),%eax
  800fa1:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800fa5:	c7 44 24 08 40 13 80 	movl   $0x801340,0x8(%esp)
  800fac:	00 
  800fad:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  800fb4:	00 
  800fb5:	8d 45 f3             	lea    -0xd(%ebp),%eax
  800fb8:	89 04 24             	mov    %eax,(%esp)
  800fbb:	e8 20 fe ff ff       	call   800de0 <snprintf>
    if (fork() == 0) {
  800fc0:	e8 29 f2 ff ff       	call   8001ee <fork>
  800fc5:	85 c0                	test   %eax,%eax
  800fc7:	75 1d                	jne    800fe6 <forkchild+0x6c>
        forktree(nxt);
  800fc9:	8d 45 f3             	lea    -0xd(%ebp),%eax
  800fcc:	89 04 24             	mov    %eax,(%esp)
  800fcf:	e8 14 00 00 00       	call   800fe8 <forktree>
        yield();
  800fd4:	e8 58 f2 ff ff       	call   800231 <yield>
        exit(0);
  800fd9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800fe0:	e8 ea f1 ff ff       	call   8001cf <exit>
        return;
  800fe5:	90                   	nop
    }
}
...
forktree(const char *cur) {
  ...
  800feb:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  800fee:	e8 5f f2 ff ff       	call   800252 <getpid>
  800ff3:	8b 55 08             	mov    0x8(%ebp),%edx
  800ff6:	89 54 24 08          	mov    %edx,0x8(%esp)
  800ffa:	89 44 24 04          	mov    %eax,0x4(%esp)
  800ffe:	c7 04 24 45 13 80 00 	movl   $0x801345,(%esp)
  801005:	e8 c6 f2 ff ff       	call   8002d0 <cprintf>

    forkchild(cur, '0');
  80100a:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  801011:	00 
  801012:	8b 45 08             	mov    0x8(%ebp),%eax
  801015:	89 04 24             	mov    %eax,(%esp)
  801018:	e8 5d ff ff ff       	call   800f7a <forkchild>
    forkchild(cur, '1');
  80101d:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  801024:	00 
  801025:	8b 45 08             	mov    0x8(%ebp),%eax
  801028:	89 04 24             	mov    %eax,(%esp)
  80102b:	e8 4a ff ff ff       	call   800f7a <forkchild>
}
  801030:	90                   	nop
  801031:	c9                   	leave  
  801032:	c3                   	ret    
...
main(void) {
  ...
  801036:	83 e4 f0             	and    $0xfffffff0,%esp
  801039:	83 ec 10             	sub    $0x10,%esp
    forktree("");
  80103c:	c7 04 24 56 13 80 00 	movl   $0x801356,(%esp)
  801043:	e8 a0 ff ff ff       	call   800fe8 <forktree>
    return 0;
