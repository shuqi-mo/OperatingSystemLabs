...
main(void) {
  ...
  800f8c:	c7 04 24 a0 12 80 00 	movl   $0x8012a0,(%esp)
  800f93:	e8 38 f3 ff ff       	call   8002d0 <cprintf>
    print_pgdir();
  800f98:	e8 c2 f2 ff ff       	call   80025f <print_pgdir>
    cprintf("pgdir pass.\n");
  800f9d:	c7 04 24 b7 12 80 00 	movl   $0x8012b7,(%esp)
  800fa4:	e8 27 f3 ff ff       	call   8002d0 <cprintf>
    return 0;
