...
exit(int error_code) {
  ...
  8001e0:	c7 04 24 38 10 80 00 	movl   $0x801038,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008ef:	05 64 11 80 00       	add    $0x801164,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a3f:	8b 04 85 88 11 80 00 	mov    0x801188(,%eax,4),%eax
  ...
  800b41:	c7 44 24 08 7e 11 80 	movl   $0x80117e,0x8(%esp)
  800b48:	00 
  ...
  800b6d:	75 05                	jne    800b74 <vprintfmt+0x1a3>
                p = "(null)";
  800b6f:	be 81 11 80 00       	mov    $0x801181,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800f83:	e8 ca f2 ff ff       	call   800252 <getpid>
  800f88:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f8c:	c7 04 24 e0 12 80 00 	movl   $0x8012e0,(%esp)
  800f93:	e8 38 f3 ff ff       	call   8002d0 <cprintf>
    for (i = 0; i < 5; i ++) {
  800f98:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  800f9f:	00 
  800fa0:	eb 26                	jmp    800fc8 <main+0x4e>
        yield();
  800fa2:	e8 8a f2 ff ff       	call   800231 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  800fa7:	e8 a6 f2 ff ff       	call   800252 <getpid>
  800fac:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  800fb0:	89 54 24 08          	mov    %edx,0x8(%esp)
  800fb4:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fb8:	c7 04 24 fc 12 80 00 	movl   $0x8012fc,(%esp)
  800fbf:	e8 0c f3 ff ff       	call   8002d0 <cprintf>
    for (i = 0; i < 5; i ++) {
  800fc4:	ff 44 24 1c          	incl   0x1c(%esp)
  800fc8:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  800fcd:	7e d3                	jle    800fa2 <main+0x28>
    }
    cprintf("All done in process %d.\n", getpid());
  800fcf:	e8 7e f2 ff ff       	call   800252 <getpid>
  800fd4:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fd8:	c7 04 24 1f 13 80 00 	movl   $0x80131f,(%esp)
  800fdf:	e8 ec f2 ff ff       	call   8002d0 <cprintf>
    cprintf("yield pass.\n");
  800fe4:	c7 04 24 38 13 80 00 	movl   $0x801338,(%esp)
  800feb:	e8 e0 f2 ff ff       	call   8002d0 <cprintf>
    return 0;
