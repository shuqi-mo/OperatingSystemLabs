...
main(void) {
  ...
  800f83:	66 b8 28 00          	mov    $0x28,%ax
  800f87:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  800f89:	c7 44 24 08 a0 12 80 	movl   $0x8012a0,0x8(%esp)
  800f90:	00 
  800f91:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800f98:	00 
  800f99:	c7 04 24 ab 12 80 00 	movl   $0x8012ab,(%esp)
  800fa0:	e8 7b f0 ff ff       	call   800020 <__panic>
