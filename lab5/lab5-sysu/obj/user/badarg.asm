...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008ef:	05 44 12 80 00       	add    $0x801244,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a3f:	8b 04 85 68 12 80 00 	mov    0x801268(,%eax,4),%eax
  ...
  800b41:	c7 44 24 08 5e 12 80 	movl   $0x80125e,0x8(%esp)
  800b48:	00 
  ...
  800b6d:	75 05                	jne    800b74 <vprintfmt+0x1a3>
                p = "(null)";
  800b6f:	be 61 12 80 00       	mov    $0x801261,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800f80:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  800f83:	e8 66 f2 ff ff       	call   8001ee <fork>
  800f88:	89 44 24 18          	mov    %eax,0x18(%esp)
  800f8c:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  800f91:	75 32                	jne    800fc5 <main+0x4b>
        cprintf("fork ok.\n");
  800f93:	c7 04 24 c0 13 80 00 	movl   $0x8013c0,(%esp)
  800f9a:	e8 31 f3 ff ff       	call   8002d0 <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  800f9f:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  800fa6:	00 
  800fa7:	eb 09                	jmp    800fb2 <main+0x38>
            yield();
  800fa9:	e8 83 f2 ff ff       	call   800231 <yield>
        for (i = 0; i < 10; i ++) {
  800fae:	ff 44 24 1c          	incl   0x1c(%esp)
  800fb2:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  800fb7:	7e f0                	jle    800fa9 <main+0x2f>
        }
        exit(0xbeaf);
  800fb9:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  800fc0:	e8 0a f2 ff ff       	call   8001cf <exit>
    }
    assert(pid > 0);
  800fc5:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  800fca:	7f 24                	jg     800ff0 <main+0x76>
  800fcc:	c7 44 24 0c ca 13 80 	movl   $0x8013ca,0xc(%esp)
  800fd3:	00 
  800fd4:	c7 44 24 08 d2 13 80 	movl   $0x8013d2,0x8(%esp)
  800fdb:	00 
  800fdc:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  800fe3:	00 
  800fe4:	c7 04 24 e7 13 80 00 	movl   $0x8013e7,(%esp)
  800feb:	e8 30 f0 ff ff       	call   800020 <__panic>
    assert(waitpid(-1, NULL) != 0);
  800ff0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800ff7:	00 
  800ff8:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  800fff:	e8 13 f2 ff ff       	call   800217 <waitpid>
  801004:	85 c0                	test   %eax,%eax
  801006:	75 24                	jne    80102c <main+0xb2>
  801008:	c7 44 24 0c f5 13 80 	movl   $0x8013f5,0xc(%esp)
  80100f:	00 
  801010:	c7 44 24 08 d2 13 80 	movl   $0x8013d2,0x8(%esp)
  801017:	00 
  801018:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  80101f:	00 
  801020:	c7 04 24 e7 13 80 00 	movl   $0x8013e7,(%esp)
  801027:	e8 f4 ef ff ff       	call   800020 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  80102c:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  801033:	c0 
  801034:	8b 44 24 18          	mov    0x18(%esp),%eax
  801038:	89 04 24             	mov    %eax,(%esp)
  80103b:	e8 d7 f1 ff ff       	call   800217 <waitpid>
  801040:	85 c0                	test   %eax,%eax
  801042:	75 24                	jne    801068 <main+0xee>
  801044:	c7 44 24 0c 0c 14 80 	movl   $0x80140c,0xc(%esp)
  80104b:	00 
  80104c:	c7 44 24 08 d2 13 80 	movl   $0x8013d2,0x8(%esp)
  801053:	00 
  801054:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  80105b:	00 
  80105c:	c7 04 24 e7 13 80 00 	movl   $0x8013e7,(%esp)
  801063:	e8 b8 ef ff ff       	call   800020 <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  801068:	8d 44 24 14          	lea    0x14(%esp),%eax
  80106c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801070:	8b 44 24 18          	mov    0x18(%esp),%eax
  801074:	89 04 24             	mov    %eax,(%esp)
  801077:	e8 9b f1 ff ff       	call   800217 <waitpid>
  80107c:	85 c0                	test   %eax,%eax
  80107e:	75 0b                	jne    80108b <main+0x111>
  801080:	8b 44 24 14          	mov    0x14(%esp),%eax
  801084:	3d af be 00 00       	cmp    $0xbeaf,%eax
  801089:	74 24                	je     8010af <main+0x135>
  80108b:	c7 44 24 0c 34 14 80 	movl   $0x801434,0xc(%esp)
  801092:	00 
  801093:	c7 44 24 08 d2 13 80 	movl   $0x8013d2,0x8(%esp)
  80109a:	00 
  80109b:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  8010a2:	00 
  8010a3:	c7 04 24 e7 13 80 00 	movl   $0x8013e7,(%esp)
  8010aa:	e8 71 ef ff ff       	call   800020 <__panic>
    cprintf("badarg pass.\n");
  8010af:	c7 04 24 69 14 80 00 	movl   $0x801469,(%esp)
  8010b6:	e8 15 f2 ff ff       	call   8002d0 <cprintf>
    return 0;
