...
main(void) {
  ...
  800f83:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  800f8a:	00 
  800f8b:	eb 5f                	jmp    800fec <main+0x72>
        if ((pid = fork()) == 0) {
  800f8d:	e8 5c f2 ff ff       	call   8001ee <fork>
  800f92:	89 44 24 18          	mov    %eax,0x18(%esp)
  800f96:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  800f9b:	75 20                	jne    800fbd <main+0x43>
            cprintf("I am child %d\n", n);
  800f9d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800fa1:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fa5:	c7 04 24 84 13 80 00 	movl   $0x801384,(%esp)
  800fac:	e8 1f f3 ff ff       	call   8002d0 <cprintf>
            exit(0);
  800fb1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800fb8:	e8 12 f2 ff ff       	call   8001cf <exit>
        }
        assert(pid > 0);
  800fbd:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  800fc2:	7f 24                	jg     800fe8 <main+0x6e>
  800fc4:	c7 44 24 0c 93 13 80 	movl   $0x801393,0xc(%esp)
  800fcb:	00 
  800fcc:	c7 44 24 08 9b 13 80 	movl   $0x80139b,0x8(%esp)
  800fd3:	00 
  800fd4:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  800fdb:	00 
  800fdc:	c7 04 24 b0 13 80 00 	movl   $0x8013b0,(%esp)
  800fe3:	e8 38 f0 ff ff       	call   800020 <__panic>
    for (n = 0; n < max_child; n ++) {
  800fe8:	ff 44 24 1c          	incl   0x1c(%esp)
  800fec:	b8 20 00 00 00       	mov    $0x20,%eax
  800ff1:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  800ff5:	7c 96                	jl     800f8d <main+0x13>
    }

    if (n > max_child) {
  800ff7:	b8 20 00 00 00       	mov    $0x20,%eax
  800ffc:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801000:	7e 4d                	jle    80104f <main+0xd5>
        panic("fork claimed to work %d times!\n", n);
  801002:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801006:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80100a:	c7 44 24 08 c0 13 80 	movl   $0x8013c0,0x8(%esp)
  801011:	00 
  801012:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801019:	00 
  80101a:	c7 04 24 b0 13 80 00 	movl   $0x8013b0,(%esp)
  801021:	e8 fa ef ff ff       	call   800020 <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  801026:	e8 d0 f1 ff ff       	call   8001fb <wait>
  80102b:	85 c0                	test   %eax,%eax
  80102d:	74 1c                	je     80104b <main+0xd1>
            panic("wait stopped early\n");
  80102f:	c7 44 24 08 e0 13 80 	movl   $0x8013e0,0x8(%esp)
  801036:	00 
  801037:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  80103e:	00 
  80103f:	c7 04 24 b0 13 80 00 	movl   $0x8013b0,(%esp)
  801046:	e8 d5 ef ff ff       	call   800020 <__panic>
    for (; n > 0; n --) {
  80104b:	ff 4c 24 1c          	decl   0x1c(%esp)
  80104f:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801054:	7f d0                	jg     801026 <main+0xac>
        }
    }

    if (wait() == 0) {
  801056:	e8 a0 f1 ff ff       	call   8001fb <wait>
  80105b:	85 c0                	test   %eax,%eax
  80105d:	75 1c                	jne    80107b <main+0x101>
        panic("wait got too many\n");
  80105f:	c7 44 24 08 f4 13 80 	movl   $0x8013f4,0x8(%esp)
  801066:	00 
  801067:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  80106e:	00 
  80106f:	c7 04 24 b0 13 80 00 	movl   $0x8013b0,(%esp)
  801076:	e8 a5 ef ff ff       	call   800020 <__panic>
    }

    cprintf("forktest pass.\n");
  80107b:	c7 04 24 07 14 80 00 	movl   $0x801407,(%esp)
  801082:	e8 49 f2 ff ff       	call   8002d0 <cprintf>
    return 0;
