...
main(void) {
  ...
  800f80:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  800f83:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  800f85:	c7 44 24 08 a0 12 80 	movl   $0x8012a0,0x8(%esp)
  800f8c:	00 
  800f8d:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  800f94:	00 
  800f95:	c7 04 24 ab 12 80 00 	movl   $0x8012ab,(%esp)
  800f9c:	e8 7f f0 ff ff       	call   800020 <__panic>
