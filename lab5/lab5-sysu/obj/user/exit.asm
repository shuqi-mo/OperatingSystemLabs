...
main(void) {
  ...
  800f83:	c7 04 24 c0 13 80 00 	movl   $0x8013c0,(%esp)
  800f8a:	e8 41 f3 ff ff       	call   8002d0 <cprintf>
    if ((pid = fork()) == 0) {
  800f8f:	e8 5a f2 ff ff       	call   8001ee <fork>
  800f94:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  800f98:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  800f9d:	75 3c                	jne    800fdb <main+0x61>
        cprintf("I am the child.\n");
  800f9f:	c7 04 24 e7 13 80 00 	movl   $0x8013e7,(%esp)
  800fa6:	e8 25 f3 ff ff       	call   8002d0 <cprintf>
        yield();
  800fab:	e8 81 f2 ff ff       	call   800231 <yield>
        yield();
  800fb0:	e8 7c f2 ff ff       	call   800231 <yield>
        yield();
  800fb5:	e8 77 f2 ff ff       	call   800231 <yield>
        yield();
  800fba:	e8 72 f2 ff ff       	call   800231 <yield>
        yield();
  800fbf:	e8 6d f2 ff ff       	call   800231 <yield>
        yield();
  800fc4:	e8 68 f2 ff ff       	call   800231 <yield>
        yield();
  800fc9:	e8 63 f2 ff ff       	call   800231 <yield>
        exit(magic);
  800fce:	a1 08 20 80 00       	mov    0x802008,%eax
  800fd3:	89 04 24             	mov    %eax,(%esp)
  800fd6:	e8 f4 f1 ff ff       	call   8001cf <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  800fdb:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800fdf:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fe3:	c7 04 24 f8 13 80 00 	movl   $0x8013f8,(%esp)
  800fea:	e8 e1 f2 ff ff       	call   8002d0 <cprintf>
    }
    assert(pid > 0);
  800fef:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  800ff4:	7f 24                	jg     80101a <main+0xa0>
  800ff6:	c7 44 24 0c 1a 14 80 	movl   $0x80141a,0xc(%esp)
  800ffd:	00 
  800ffe:	c7 44 24 08 22 14 80 	movl   $0x801422,0x8(%esp)
  801005:	00 
  801006:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  80100d:	00 
  80100e:	c7 04 24 37 14 80 00 	movl   $0x801437,(%esp)
  801015:	e8 06 f0 ff ff       	call   800020 <__panic>
    cprintf("I am the parent, waiting now..\n");
  80101a:	c7 04 24 44 14 80 00 	movl   $0x801444,(%esp)
  801021:	e8 aa f2 ff ff       	call   8002d0 <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  801026:	8d 44 24 18          	lea    0x18(%esp),%eax
  80102a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80102e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801032:	89 04 24             	mov    %eax,(%esp)
  801035:	e8 dd f1 ff ff       	call   800217 <waitpid>
  80103a:	85 c0                	test   %eax,%eax
  80103c:	75 0d                	jne    80104b <main+0xd1>
  80103e:	8b 54 24 18          	mov    0x18(%esp),%edx
  801042:	a1 08 20 80 00       	mov    0x802008,%eax
  801047:	39 c2                	cmp    %eax,%edx
  801049:	74 24                	je     80106f <main+0xf5>
  80104b:	c7 44 24 0c 64 14 80 	movl   $0x801464,0xc(%esp)
  801052:	00 
  801053:	c7 44 24 08 22 14 80 	movl   $0x801422,0x8(%esp)
  80105a:	00 
  80105b:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  801062:	00 
  801063:	c7 04 24 37 14 80 00 	movl   $0x801437,(%esp)
  80106a:	e8 b1 ef ff ff       	call   800020 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  80106f:	8d 44 24 18          	lea    0x18(%esp),%eax
  801073:	89 44 24 04          	mov    %eax,0x4(%esp)
  801077:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80107b:	89 04 24             	mov    %eax,(%esp)
  80107e:	e8 94 f1 ff ff       	call   800217 <waitpid>
  801083:	85 c0                	test   %eax,%eax
  801085:	74 09                	je     801090 <main+0x116>
  801087:	e8 6f f1 ff ff       	call   8001fb <wait>
  80108c:	85 c0                	test   %eax,%eax
  80108e:	75 24                	jne    8010b4 <main+0x13a>
  801090:	c7 44 24 0c 90 14 80 	movl   $0x801490,0xc(%esp)
  801097:	00 
  801098:	c7 44 24 08 22 14 80 	movl   $0x801422,0x8(%esp)
  80109f:	00 
  8010a0:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8010a7:	00 
  8010a8:	c7 04 24 37 14 80 00 	movl   $0x801437,(%esp)
  8010af:	e8 6c ef ff ff       	call   800020 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  8010b4:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010b8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010bc:	c7 04 24 b8 14 80 00 	movl   $0x8014b8,(%esp)
  8010c3:	e8 08 f2 ff ff       	call   8002d0 <cprintf>

    cprintf("exit pass.\n");
  8010c8:	c7 04 24 c8 14 80 00 	movl   $0x8014c8,(%esp)
  8010cf:	e8 fc f1 ff ff       	call   8002d0 <cprintf>
    return 0;
