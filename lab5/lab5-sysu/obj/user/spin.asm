...
main(void) {
  ...
  800f9d:	75 0e                	jne    800fad <main+0x33>
        cprintf("I am the child. spinning ...\n");
  800f9f:	c7 04 24 a7 13 80 00 	movl   $0x8013a7,(%esp)
  800fa6:	e8 25 f3 ff ff       	call   8002d0 <cprintf>
        while (1);
  800fab:	eb fe                	jmp    800fab <main+0x31>
    }
    cprintf("I am the parent. Running the child...\n");
  800fad:	c7 04 24 c8 13 80 00 	movl   $0x8013c8,(%esp)
  800fb4:	e8 17 f3 ff ff       	call   8002d0 <cprintf>

    yield();
  800fb9:	e8 73 f2 ff ff       	call   800231 <yield>
    yield();
  800fbe:	e8 6e f2 ff ff       	call   800231 <yield>
    yield();
  800fc3:	e8 69 f2 ff ff       	call   800231 <yield>

    cprintf("I am the parent.  Killing the child...\n");
  800fc8:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  800fcf:	e8 fc f2 ff ff       	call   8002d0 <cprintf>

    assert((ret = kill(pid)) == 0);
  800fd4:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800fd8:	89 04 24             	mov    %eax,(%esp)
  800fdb:	e8 5f f2 ff ff       	call   80023f <kill>
  800fe0:	89 44 24 18          	mov    %eax,0x18(%esp)
  800fe4:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  800fe9:	74 24                	je     80100f <main+0x95>
  800feb:	c7 44 24 0c 18 14 80 	movl   $0x801418,0xc(%esp)
  800ff2:	00 
  800ff3:	c7 44 24 08 2f 14 80 	movl   $0x80142f,0x8(%esp)
  800ffa:	00 
  800ffb:	c7 44 24 04 14 00 00 	movl   $0x14,0x4(%esp)
  801002:	00 
  801003:	c7 04 24 44 14 80 00 	movl   $0x801444,(%esp)
  80100a:	e8 11 f0 ff ff       	call   800020 <__panic>
    cprintf("kill returns %d\n", ret);
  80100f:	8b 44 24 18          	mov    0x18(%esp),%eax
  801013:	89 44 24 04          	mov    %eax,0x4(%esp)
  801017:	c7 04 24 50 14 80 00 	movl   $0x801450,(%esp)
  80101e:	e8 ad f2 ff ff       	call   8002d0 <cprintf>
  ...
  801032:	e8 e0 f1 ff ff       	call   800217 <waitpid>
  801037:	89 44 24 18          	mov    %eax,0x18(%esp)
  80103b:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801040:	74 24                	je     801066 <main+0xec>
  801042:	c7 44 24 0c 64 14 80 	movl   $0x801464,0xc(%esp)
  801049:	00 
  80104a:	c7 44 24 08 2f 14 80 	movl   $0x80142f,0x8(%esp)
  801051:	00 
  801052:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801059:	00 
  80105a:	c7 04 24 44 14 80 00 	movl   $0x801444,(%esp)
  801061:	e8 ba ef ff ff       	call   800020 <__panic>
    cprintf("wait returns %d\n", ret);
  801066:	8b 44 24 18          	mov    0x18(%esp),%eax
  80106a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80106e:	c7 04 24 84 14 80 00 	movl   $0x801484,(%esp)
  801075:	e8 56 f2 ff ff       	call   8002d0 <cprintf>

    cprintf("spin may pass.\n");
  80107a:	c7 04 24 95 14 80 00 	movl   $0x801495,(%esp)
  801081:	e8 4a f2 ff ff       	call   8002d0 <cprintf>
    return 0;
