...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008ef:	05 24 11 80 00       	add    $0x801124,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a3f:	8b 04 85 48 11 80 00 	mov    0x801148(,%eax,4),%eax
  ...
  800b41:	c7 44 24 08 3e 11 80 	movl   $0x80113e,0x8(%esp)
  800b48:	00 
  ...
  800b6d:	75 05                	jne    800b74 <vprintfmt+0x1a3>
                p = "(null)";
  800b6f:	be 41 11 80 00       	mov    $0x801141,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800f80:	83 ec 10             	sub    $0x10,%esp
    cprintf("value is %d.\n", 1 / zero);
  800f83:	8b 0d 08 20 80 00    	mov    0x802008,%ecx
  800f89:	b8 01 00 00 00       	mov    $0x1,%eax
  800f8e:	99                   	cltd   
  800f8f:	f7 f9                	idiv   %ecx
  800f91:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f95:	c7 04 24 a0 12 80 00 	movl   $0x8012a0,(%esp)
  800f9c:	e8 2f f3 ff ff       	call   8002d0 <cprintf>
    panic("FAIL: T.T\n");
  800fa1:	c7 44 24 08 ae 12 80 	movl   $0x8012ae,0x8(%esp)
  800fa8:	00 
  800fa9:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800fb0:	00 
  800fb1:	c7 04 24 b9 12 80 00 	movl   $0x8012b9,(%esp)
  800fb8:	e8 63 f0 ff ff       	call   800020 <__panic>
