...
main(void) {
  ...
  800f83:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  800f88:	8b 00                	mov    (%eax),%eax
  800f8a:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f8e:	c7 04 24 a0 12 80 00 	movl   $0x8012a0,(%esp)
  800f95:	e8 36 f3 ff ff       	call   8002d0 <cprintf>
    panic("FAIL: T.T\n");
  800f9a:	c7 44 24 08 be 12 80 	movl   $0x8012be,0x8(%esp)
  800fa1:	00 
  800fa2:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  800fa9:	00 
  800faa:	c7 04 24 c9 12 80 00 	movl   $0x8012c9,(%esp)
  800fb1:	e8 6a f0 ff ff       	call   800020 <__panic>
